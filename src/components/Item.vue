        ...
        <Row>
            <Col span="8">
                <Menu active-name="1" :open-names="['1']">
                    <MenuItem name="1" @click.native="changeMenuItem(1)">TodoList列表</MenuItem>
                    <MenuItem name="2" @click.native="changeMenuItem(2)">我的</MenuItem>
                </Menu>
            </Col>
            <Col span="8">
                <div v-if="isList">
                ...
                <div v-else>
                    <p>头像：<Icon type="ios-basketball" /></p>
